...
func getFeature(r *http.Request) (*geojson.Feature, string, error) {
	...
	if err != nil {
		slog.Error("Failed to get request body")
		return nil, "", err
	}
...
func (s *Storage) Run() {
	...
	if err != nil {
		panic("Failed to create db dir")
	}
}
func (s *Storage) Stop() {
	err := os.RemoveAll(s.dir)
	if err != nil {
		panic("Failed to revove db dir")
	}
}
